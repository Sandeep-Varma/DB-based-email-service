...
const DeptAllCoursePage=()=>{
    ...
    useEffect(()=>{
    const f=async()=>{
        fetch('http://localhost:4000/all_dept_courses/'+dept_name, {
            method: 'GET',
            mode: 'cors',
            credentials: 'include',
        })
    ...
    if (!done) return (
        ...
        <div>
            <h2 style={{textAlign: 'center'}}>All Courses of {dept_name}</h2>
                    ...
                    {Object.keys(data).map((k, i) => {
                        ...
                        return (
                            <tr style={{backgroundColor: '#f2f2f2'}}>
                                ...
                                <td style={{border: '1px solid black', padding: '8px'}}>{n.credits}</td>
                            </tr>
                        )
                    }
                    )}
...
export default DeptAllCoursePage;